...
| "what are our conventions", "set up linting", "enforce style", "does the code still follow our standards" | `coding-standards` | `docs/standards.md` plus lint config, or `docs/audits/<date>-standards.md` in assess mode, or `docs/audits/<date>-standards-audit.md` in audit mode |
