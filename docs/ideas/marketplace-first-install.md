...
| Upgrading assumes the CLI lives in a clone updated by `git pull` | `README.md:95-99`, the three-layer table | Under a marketplace install there is no clone. The table collapses from three layers to two |
